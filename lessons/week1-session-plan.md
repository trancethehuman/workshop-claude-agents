...
**Overview:**
- Pre-flight check (Node.js, Git, Claude Pro)
- Install Claude Code CLI
- Clone workshop repository
- Authenticate and test

**Success criteria:** Claude responds correctly to "What files are in this repository?"
...
- Preview the startup funding database

**Success criteria:**
- Tools tested and working
- CLAUDE.md customized
- Database accessible via Claude
